...
const SITE_URL = "https://toutfeutoutflamme31.fr";
...
const seoCities = [
  {
    ...
    name: "Saint-Gaudens",
    intro:
      "À Saint-Gaudens et dans tout le Comminges, les conditions hivernales favorisent les phénomènes de condensation et d’encrassement des conduits.",
    zones:
      "Intervention également à Montréjeau, Aspet, Aurignac, Labarthe-Rivière et alentours."
  },
  {
    slug: "muret",
    name: "Muret",
    intro:
      "À Muret, les installations de poêles à granulés sont souvent récentes mais nécessitent un entretien rigoureux pour garantir leur performance.",
    zones:
      "Intervention également à Eaunes, Roques, Seysses, Pins-Justaret et alentours."
  },
  {
    slug: "cazeres",
    name: "Cazères",
    intro:
      "À Cazères, l’humidité et les variations de température peuvent provoquer des problèmes de tirage et de condensation.",
    zones:
      "Intervention également à Martres-Tolosane, Palaminy, Le Fousseret et alentours."
  },
  {
    slug: "carbonne",
    name: "Carbonne",
    intro:
      "À Carbonne, un entretien régulier permet d’éviter les pertes de rendement et les pannes en période de chauffe.",
    zones:
      "Intervention également à Noé, Longages, Capens et alentours."
  },
  {
    slug: "montrejeau",
    name: "Montréjeau",
    intro:
      "À Montréjeau, les installations anciennes nécessitent souvent un contrôle approfondi pour garantir sécurité et performance.",
    zones:
      "Intervention également à Gourdan-Polignan, Loures-Barousse et alentours."
  },
  {
    slug: "aurignac",
    name: "Aurignac",
    intro:
      "En zone rurale comme Aurignac, les conduits sont souvent longs et sensibles au refroidissement des fumées.",
    zones:
      "Intervention également à Alan, Boussan et alentours."
  },
  {
  slug: "lannemezan",
  name: "Lannemezan",
  intro:
    "À Lannemezan, les températures froides et l’altitude favorisent les contraintes sur les installations de chauffage.",
  zones:
    "Intervention également à Capvern, La Barthe-de-Neste et alentours."
},
{
  slug: "saint-girons",
  name: "Saint-Girons",
  intro:
    "À Saint-Girons, l’humidité et les conduits anciens nécessitent une attention particulière.",
  zones:
    "Intervention également à Foix, Massat et alentours."
},
{
  slug: "cugnaux",
  name: "Cugnaux",
  intro:
    "À Cugnaux, les habitations récentes nécessitent un entretien régulier pour conserver un bon rendement.",
  zones:
    "Intervention également à Villeneuve-Tolosane, Portet-sur-Garonne et alentours."
},
{
  slug: "eaunes",
  name: "Eaunes",
  intro:
    "À Eaunes, les installations de poêles à granulés demandent un suivi régulier pour éviter les pannes hivernales.",
  zones:
    "Intervention également à Muret, Labarthe-sur-Lèze et alentours."
},
{
  slug: "longages",
  name: "Longages",
  intro:
    "À Longages, un entretien annuel permet de prévenir les problèmes de tirage et d’encrassement.",
  zones:
    "Intervention également à Noé, Carbonne et alentours."
},
{
  slug: "noe",
  name: "Noé",
  intro:
    "À Noé, les variations de température influencent directement le fonctionnement des conduits.",
  zones:
    "Intervention également à Longages, Capens et alentours."
},
{
  slug: "martres-tolosane",
  name: "Martres-Tolosane",
  intro:
    "À Martres-Tolosane, les installations nécessitent un entretien rigoureux pour garantir sécurité et performance.",
  zones:
    "Intervention également à Cazères, Boussens et alentours."
}
];
...
const seoProblems = [
  "vitre noire ou encrassement rapide",
  "défaut d’allumage ou poêle qui s’éteint",
  "tirage insuffisant ou défaut dépression",
  "surconsommation de granulés",
  "bruit anormal de l’extracteur ou du ventilateur",
  "condensation dans le conduit et point de rosée",
];

function buildFaqSchema(faqs = seoFaqs) {
  return {
    "@type": "FAQPage",
...
function buildCityFaqs(city) {
  return [
    {
      question: `Intervenez-vous à ${city.name} et dans les communes autour ?`,
      answer: `Oui, Tout Feu Tout Flamme intervient à ${city.name} et dans les communes voisines pour l’entretien annuel, le ramonage mécanique avec certificat et le dépannage de poêles à granulés. ${city.zones}`,
    },
    {
      question: `Pourquoi faire entretenir son poêle à granulés à ${city.name} ?`,
      answer: `Dans le secteur de ${city.name}, l’humidité, les variations de température, le tirage du conduit et l’usage intensif en hiver peuvent accélérer l’encrassement. Un entretien régulier aide à préserver la sécurité et le rendement de l’appareil.`,
    },
    ...seoFaqs,
  ];
}

function buildSeoGraph(url, faqs = seoFaqs) {
  return {
...
const blogArticles = [
  ...
  date: "3 mai 2026",
  category: "Conseils",
  image: "/blog/fabrication-pellets.webp",
  excerpt:
    "Sciure, séchage, compression, refroidissement… découvrez comment sont fabriqués les pellets et pourquoi leur qualité influence directement votre poêle à granulés.",
  content: `
    <p>Les pellets, aussi appelés granulés de bois, sont devenus une référence pour le chauffage moderne. Compacts, propres et faciles à utiliser, ils alimentent aujourd’hui de nombreux poêles à granulés en Haute-Garonne et dans le Comminges.</p>

    <p>Mais derrière ces petits cylindres de bois se cache un processus de fabrication précis. La qualité du pellet influence directement le rendement du poêle, l’encrassement, la consommation et la durée de vie de l’appareil.</p>

    <p>Tout Feu Tout Flamme, spécialiste de l’entretien de poêles à granulés à Saint-Gaudens, vous explique les grandes étapes de fabrication des pellets.</p>

    <h2>1. La matière première : des résidus de bois valorisés</h2>

    <p>Les pellets sont principalement fabriqués à partir de sciure, copeaux et résidus de bois issus des scieries et de l’industrie du bois.</p>

    <p>La matière utilisée doit être propre, sèche et non traitée. Un pellet de qualité ne contient pas de colle chimique : c’est la lignine naturellement présente dans le bois qui agit comme liant lors de la compression.</p>

    <ul>
      <li>Sciure de bois non traité</li>
      <li>Copeaux propres</li>
      <li>Résidus de scierie valorisés</li>
      <li>Absence de peinture, vernis ou traitement chimique</li>
    </ul>

    <h2>2. Le séchage : une étape essentielle</h2>

    <p>Avant d’être transformée en granulés, la sciure doit être séchée. Cette étape est déterminante, car un taux d’humidité trop élevé provoque une mauvaise combustion.</p>

    <p>Un pellet trop humide peut entraîner une baisse de rendement, davantage de cendres, une vitre qui noircit plus vite et un encrassement prématuré du poêle.</p>

    <blockquote>
      <p><strong>Le saviez-vous ?</strong> Plus un pellet est sec et régulier, meilleure sera la combustion dans votre poêle à granulés.</p>
    </blockquote>

    <h2>3. Le broyage : obtenir une matière homogène</h2>

    <p>Une fois séchée, la matière est broyée finement afin d’obtenir une granulométrie régulière.</p>

    <p>Cette homogénéité est importante pour garantir une compression stable et produire des pellets de diamètre constant. Un granulé irrégulier peut perturber l’alimentation du poêle par la vis sans fin.</p>

    <h2>4. La compression : naissance du granulé</h2>

    <img src="/blog/presse-granules.webp" alt="fabrication des granulés" class="my-6 rounded-xl shadow-lg" /> 

    <p>La sciure est ensuite compressée à haute pression dans une presse à granulés. Sous l’effet de la pression et de la chaleur, la lignine du bois se ramollit et permet aux particules de se lier naturellement entre elles.</p>

    <p>C’est cette étape qui donne au pellet sa forme cylindrique, sa densité et sa résistance mécanique.</p>

    <ul>
      <li>Compression à haute pression</li>
      <li>Activation naturelle de la lignine</li>
      <li>Formation du granulé sans colle ajoutée</li>
      <li>Obtention d’un combustible dense et régulier</li>
    </ul>

    <h2>5. Le refroidissement et le tamisage</h2>

    <p>À la sortie de la presse, les pellets sont chauds et encore fragiles. Ils sont donc refroidis afin de stabiliser leur structure.</p>

    <p>Ils sont ensuite tamisés pour retirer les poussières et les fines particules. Cette étape est importante : trop de poussière dans les sacs peut favoriser l’encrassement du creuset et perturber la combustion.</p>

    <h2>6. Le conditionnement et le stockage</h2>

    <p>Les pellets sont généralement conditionnés en sacs de 15 kg ou livrés en vrac pour les installations équipées d’un silo.</p>

    <p>Le stockage doit toujours se faire dans un endroit sec. L’humidité est l’ennemi numéro un du granulé de bois : elle le fait gonfler, se désagréger et perdre une partie de ses qualités de combustion.</p>

    <h2>Comment reconnaître un bon pellet ?</h2>

    <p>Un pellet de qualité se reconnaît à plusieurs signes simples.</p>

    <ul>
      <li>Il est dur et compact.</li>
      <li>Il produit peu de poussière dans le sac.</li>
      <li>Il présente un diamètre régulier.</li>
      <li>Il brûle avec une flamme vive et stable.</li>
      <li>Il laisse peu de cendres après combustion.</li>
      <li>Il bénéficie idéalement d’une certification comme ENplus A1 ou DINplus.</li>
    </ul>

    <h2>Pourquoi la qualité des pellets est importante pour votre poêle ?</h2>

    <p>Un pellet bas de gamme peut provoquer de nombreux désagréments au quotidien.</p>

    <ul>
      <li>Creuset qui s’encrasse rapidement</li>
      <li>Vitre noire plus fréquente</li>
      <li>Surconsommation de granulés</li>
      <li>Mauvaise combustion</li>
      <li>Dépôts dans l’échangeur et le conduit</li>
      <li>Défauts d’allumage ou mises en sécurité</li>
    </ul>

    <p>À l’inverse, un granulé de bonne qualité permet une combustion plus propre, une chaleur plus régulière et un meilleur confort d’utilisation.</p>

    <h2>Pellets de qualité et entretien : le duo gagnant</h2>

    <p>Même avec de très bons granulés, un poêle à pellets doit être entretenu régulièrement. La combustion produit toujours des cendres, des poussières et des dépôts dans certaines zones de l’appareil.</p>

    <p>Un entretien annuel professionnel permet de nettoyer l’appareil en profondeur, de contrôler les organes de sécurité, de vérifier la combustion et de réaliser le ramonage mécanique du conduit.</p>

    <blockquote>
      <p><strong>Conseil Tout Feu Tout Flamme :</strong> un bon pellet limite l’encrassement, mais il ne remplace jamais l’entretien annuel du poêle à granulés.</p>
    </blockquote>

    <h2>Entretien de poêle à granulés autour de Saint-Gaudens</h2>

    <p>Vous habitez à Saint-Gaudens, Montréjeau, Lannemezan, Aspet, Salies-du-Salat ou dans le Comminges ? Tout Feu Tout Flamme intervient pour l’entretien, le ramonage mécanique, le dépannage et les contrats d’entretien de poêles à granulés.</p>

    <p>Bien choisir ses pellets, c’est préserver son appareil. Faire entretenir son poêle régulièrement, c’est garantir sa sécurité, son rendement et sa longévité.</p>
  `,
},
  {
...
function App() {
  return (
    <>
      ...
      {/* BANDE CENTRALE BLEUE DÉFILANTE */}
      <main className="relative z-10 flex justify-center">
        <div className="w-full max-w-7xl border-x border-white/15 bg-transparent text-white shadow-2xl shadow-black/40">
          <AppRouter />
        </div>
      </main>
    </>
...
function CityPage({ city }) {
  return (
    <>
      <SEO
        title={`Entretien poêle à granulés ${city.name} | Ramonage & dépannage`}
        description={`Entretien, ramonage mécanique avec certificat, dépannage et contrat d’entretien de poêle à granulés à ${city.name} et alentours. Intervention Tout Feu Tout Flamme.`}
        route={`/ville/${city.slug}`}
        keywords={[
          `entretien poêle à granulés ${city.name}`,
          `ramonage poêle granulés ${city.name}`,
          `dépannage poêle à granulés ${city.name}`,
          `contrat entretien poêle ${city.name}`,
          "Tout Feu Tout Flamme",
        ]}
        schema={buildSeoGraph(`${SITE_URL}/ville/${city.slug}`, buildCityFaqs(city))}
      />

      <section className="max-w-4xl mx-auto px-6 py-16 text-white">
        <h1 className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-[#3a86ff] to-[#4cc9f0] bg-clip-text text-transparent">
        ...
        <p className="mb-6">
          Vous recherchez un professionnel pour l’entretien de votre poêle à granulés à {city.name} ?
          <strong> Tout Feu Tout Flamme</strong> intervient rapidement pour assurer :
        </p>

        <ul className="mb-8 space-y-2">
          <li>✔ Entretien annuel complet</li>
          <li>✔ Ramonage mécanique avec certificat</li>
          <li>✔ Contrôle sécurité et combustion</li>
          <li>✔ Dépannage toutes marques</li>
        </ul>

        <h2 className="text-2xl md:text-3xl font-bold text-[#4cc9f0]">
          Pourquoi entretenir son poêle à granulés à {city.name} ?
        </h2>

        <p className="mb-6">
          Un entretien régulier permet d’éviter les pannes, d’améliorer le rendement
          et de prolonger la durée de vie de votre appareil. Il est également obligatoire
          pour votre assurance.
        </p>

        <h2 className="text-2xl md:text-3xl font-bold text-[#4cc9f0]">
           Attention au point de rosée à {city.name}
        </h2>

          <p className="mb-6">
           Un conduit mal isolé ou trop froid peut provoquer de la condensation,
           appelée point de rosée. Cela entraîne corrosion, encrassement et perte de performance.
          </p>
        ...
        <p className="mb-10">{city.zones}</p>

        <p className="mb-6">
          Dans le secteur de {city.name}, les installations de poêles à granulés
          peuvent être influencées par :
        </p>

        <ul className="mb-8 space-y-2">
         <li>✔ L’humidité ambiante</li>
         <li>✔ Le type d’habitation</li>
         <li>✔ La longueur du conduit</li>
         <li>✔ Le tirage naturel</li>
        </ul>

        <section className="my-12 rounded-[2rem] border border-white/10 bg-white/[0.055] p-6 shadow-2xl shadow-black/10 backdrop-blur-xl">
          <p className="text-sm font-black uppercase tracking-[0.32em] text-[#f77f00]">
            Expertise locale
          </p>

          <h2 className="mt-3 text-2xl md:text-3xl font-bold text-white">
            Entretien, dépannage et ramonage de poêles à granulés à {city.name}
          </h2>

          <p className="mt-5 leading-8 text-white/75">
            Tout Feu Tout Flamme accompagne les particuliers autour de {city.name} pour maintenir leur poêle à granulés dans les meilleures conditions de sécurité et de performance. L’objectif est simple : limiter les pannes en pleine saison, conserver une combustion propre et prolonger la durée de vie de l’appareil.
          </p>

          <div className="mt-8 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-5">
              <h3 className="font-bold text-[#4cc9f0]">Problèmes fréquents constatés</h3>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-5">
              <h3 className="font-bold text-[#4cc9f0]">Marques et appareils suivis</h3>
              <p className="mt-4 leading-7 text-white/75">
                Intervention sur poêles à granulés toutes marques selon configuration : {seoBrands.join(", ")} et autres appareils équipés de cartes électroniques et systèmes de combustion similaires.
              </p>
            </div>
          </div>
        </section>

        <FAQSection faqs={buildCityFaqs(city)} title={`Questions fréquentes à ${city.name}`} />

        <a
          href={SUBSCRIBE_URL}
          className="inline-block bg-gradient-to-r from-[#f77f00] to-[#ffb703] px-6 py-3 rounded-xl font-semibold shadow-lg hover:scale-105 transition"
        >
          Souscrire à un contrat d’entretien →
        </a>
        <h2 className="text-2xl md:text-3xl font-bold text-[#4cc9f0]">
  Nos interventions autour de {city.name}
</h2>
...
function FAQSection({ faqs = seoFaqs, title = "Questions fréquentes" }) {
  return (
...
function Layout({ children }) {
  ...
  return (
    <main className="min-h-screen text-white">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-transparent shadow-2xl shadow-black/20 backdrop-blur-2xl">
...
function StationTechniqueSection() {
  const badges = [
    "Station technique",
    "Pièces & diagnostic",
...
function LogoCard({ src, alt }) {
  return (
    <div className="flex items-center justify-center rounded-2xl border border-white/10 bg-white/[0.04] p-6">
      <img src={src} alt={alt} className="h-16 object-contain opacity-95" />
    </div>
  );
}
...
<div className="relative z-20 mx-auto mb-10 flex w-full max-w-full justify-center overflow-hidden px-4">
  ...
  >
    Tout Feu Tout Flamme
      ...
      <p className="text-xs font-black uppercase tracking-[0.34em] text-[#4cc9f0] md:text-sm">
        Benjamin Plessis
      </p>
...
function TarifsPage() {
  return (
    <section className="mx-auto max-w-7xl px-5 py-16">
      ...
      <div className="rounded-[2rem] border border-white/10 bg-[#0b132b] p-7 shadow-[0_10px_40px_rgba(0,0,0,0.6)] transition hover:scale-[1.02]">
...
>
      {offer.featured && (
        <div className="absolute -top-4 left-1/2 -translate-x-1/2 rounded-full bg-gradient-to-r from-[#3a86ff] via-[#4cc9f0] to-[#f77f00] px-4 py-1 text-xs font-black uppercase tracking-widest text-whitering-2 ring-[#f77f00]
shadow-[0_0_40px_rgba(247,127,0,0.25)]">
          Le plus choisi
        </div>
      )}
...
function BlogPage({ slug }) {
  const featuredSlug = "fabrication-pellets-granules-bois";
    ...
    return (
      <article className="mx-auto max-w-5xl px-5 py-16">
        ...
        <div className="overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/[0.055] shadow-2xl shadow-black/20 backdrop-blur-xl">
          <img src={article.image} alt={article.title} className="h-72 w-full object-contain md:h-96" />
  ...
  return (
    <section id="blog" className="border-t border-white/10 bg-transparent text-white">
      <SEO
        route="/blog"
      ...
      <section className="relative overflow-hidden px-5 py-20">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-14 grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-stretch">
            ...
            <div className="rounded-[2rem] border border-white/10 bg-transparent p-8 shadow-2xl shadow-black/20 backdrop-blur-xl md:p-10">
    ...
    <>
      ...
      <main className="relative overflow-hidden px-5 py-20">
        ...
        <section className="mx-auto mt-20 grid max-w-6xl gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <article className="rounded-[2rem] border border-white/10 bg-transparent p-8 shadow-2xl shadow-black/20 backdrop-blur-xl md:p-10">
            <p className="text-xs font-black uppercase tracking-[0.3em] text-[#f77f00]">Zone d’intervention</p>
            <h2 className="mt-4 font-serif text-3xl font-black text-black md:text-4xl">
          ...
          <article className="rounded-[2rem] border border-white/10 bg-white/[0.065] p-8 shadow-2xl shadow-black/20 backdrop-blur-xl md:p-10">
            <p className="text-xs font-black uppercase tracking-[0.3em] text-black">Prestations réalisées</p>
  ...
  return (
    <section className="mx-auto grid max-w-7xl gap-8 px-5 py-20 lg:grid-cols-2 lg:items-center">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
        {zones.map((zone) => (
          <div key={zone} className="rounded-2xl border border-white/10 bg-transparent px-4 py-5 text-center font-semibold text-white/75 shadow-xl shadow-black/10 backdrop-blur-xl">
...
function FinalCta() {
  return (
    <section id="contact" className="px-5 py-20">
      <div className="mx-auto max-w-7xl rounded-[2rem] border border-white/10 bg-transparent p-8 text-white shadow-2xl shadow-black/20 backdrop-blur-xl md:p-12">
...
function Footer() {
  return (
    <footer className="border-t border-white/10 bg-transparent px-5 py-8 text-sm text-white/55 backdrop-blur-xl">
    ...
    className="mt-2 text-sm text-slate-400 underline underline-offset-4 transition hover:text-white"
  >
    Gérer mes cookies
  </button>
  ...
  {seoCities.map(city => (
    <a
      key={city.slug}
      href={`/ville/${city.slug}`}
      className="text-xs text-white/50 hover:text-[#4cc9f0]"
    >
      {city.name}
    </a>
  ))}
...
function AppRouter() {
  ...
  if (route.startsWith("/ville/")) {
    const slug = route.replace("/ville/", "");
