...
function CityPage({ city }) {
  return (
    <>
      <SEO
        title={`Entretien poêle à granulés ${city.name}`}
        description={`Entretien, ramonage et dépannage de poêle à granulés à ${city.name} et alentours. Intervention rapide.`}
