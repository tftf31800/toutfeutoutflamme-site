...
function PartenariatPage() {
  const partners = [
    {
      name: "Jolly Mec",
      logo: "/logoss/jollymec.png",
      url: "https://jolly-mec.it/fr/",
    },
    {
      name: "Poele.net",
      logo: "/logoss/poele-net.png",
      url: "https://www.poelesabois.com/",
    },
    {
      name: "Palazzetti",
      logo: "/logoss/palazzetti.png",
      url: "https://palazzetti.fr/",
    },
    {
      name: "Solzaima",
      logo: "/logoss/solzaima.png",
...
function CgvPage() {
  const sections = [
    {
      title: "1. Objet",
      text: "Les présentes conditions générales de vente encadrent les prestations d’entretien, de ramonage mécanique, de diagnostic, de dépannage et les contrats annuels proposés par Tout Feu Tout Flamme pour les appareils à granulés. Toute commande implique l’acceptation pleine et entière des présentes CGV.",
    },
    {
      title: "2. Prestations proposées",
      text: "Les prestations peuvent comprendre, selon l’offre choisie : nettoyage complet de l’appareil, ramonage mécanique avec certificat, contrôles de sécurité, vérifications de fonctionnement, réglages standards, diagnostic de panne, intervention de dépannage et conseils d’utilisation. Les opérations sont réalisées dans les règles de l’art, selon les prescriptions fabricants et les normes applicables.",
    },
    {
      title: "3. Contrats d’entretien",
      text: "Les contrats d’entretien sont proposés sous forme de packs : Essentiel, Confort et Sérénité. Chaque pack précise les prestations incluses, les éventuelles priorités d’intervention, les conditions de dépannage, les limites de prise en charge, ainsi que les tarifs applicables. Le contrat signé par le client complète les présentes CGV.",
    },
    {
      title: "4. Tarifs et paiement",
      text: "Les prix sont indiqués en euros. Le paiement peut être réalisé comptant, en ligne ou selon les modalités prévues lors de la souscription. Pour les offres mensuelles, le paiement peut être effectué par prélèvement automatique SEPA lorsque cette option est proposée. Toute prestation non incluse dans le contrat fait l’objet d’un devis ou d’une information tarifaire préalable.",
    },
    {
      title: "5. Rendez-vous et accès à l’appareil",
      text: "Le client s’engage à permettre l’accès à l’appareil, à son conduit et aux éléments nécessaires à l’intervention. L’appareil doit être éteint et suffisamment refroidi avant l’arrivée du technicien. En cas d’impossibilité d’intervention imputable au client, un nouveau rendez-vous pourra être proposé et des frais de déplacement pourront être appliqués.",
    },
    {
      title: "6. Obligation de moyens",
      text: "Tout Feu Tout Flamme intervient avec sérieux et professionnalisme dans le cadre d’une obligation de moyens. Les prestations ne constituent pas une garantie absolue contre toute panne future, notamment en cas d’usure, de défaut d’installation, de mauvaise utilisation, de combustible inadapté ou de non-respect des prescriptions fabricant.",
    },
    {
      title: "7. Pièces détachées et réparations",
      text: "Les pièces détachées ne sont pas incluses sauf mention contraire dans le contrat ou le devis. Leur remplacement nécessite l’accord préalable du client. Les délais peuvent dépendre de la disponibilité fournisseur. Certaines interventions peuvent nécessiter un diagnostic complémentaire.",
    },
    {
      title: "8. Annulation et report",
      text: "Toute demande de report ou d’annulation doit être transmise dans un délai raisonnable avant le rendez-vous. En cas d’absence du client ou d’accès impossible le jour prévu, des frais pourront être facturés.",
    },
    {
      title: "9. Responsabilité",
      text: "La responsabilité de Tout Feu Tout Flamme ne saurait être engagée en cas de défaut d’installation, de conduit non conforme, de manque d’entretien antérieur, d’utilisation anormale, de modification non autorisée de l’appareil ou d’événement extérieur indépendant de sa volonté.",
    },
    {
      title: "10. Données personnelles",
      text: "Les données personnelles collectées sont utilisées uniquement pour la gestion des demandes, des rendez-vous, des contrats, des paiements, du suivi client et des obligations administratives. Elles ne sont ni revendues ni cédées à des tiers à des fins commerciales.",
    },
    {
      title: "11. Droit applicable",
      text: "Les présentes CGV sont soumises au droit français. En cas de litige, une solution amiable sera recherchée en priorité. À défaut, les juridictions compétentes pourront être saisies.",
    },
  ];
  ...
  return (
    <>
      <SEO
        ...
        description="Conditions générales de vente applicables aux prestations d’entretien, de ramonage mécanique, de dépannage et aux contrats annuels de poêles à granulés."
        keywords={[...defaultKeywords, "CGV entretien poêle à granulés", "contrat entretien poêle granulés", "ramonage mécanique certificat"]}
      />

      <main className="bg-[#070b18] text-white">
        <section className="mx-auto max-w-7xl px-5 py-16 md:py-20">
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.055] p-8 text-center shadow-2xl shadow-black/10 backdrop-blur-xl md:p-12">
            <FileSignature className="mx-auto mb-6 text-[#4cc9f0]" size={46} />
            <p className="text-sm font-black uppercase tracking-[0.35em] text-[#4cc9f0]">CGV</p>
            <h1 className="mt-4 font-serif text-4xl font-black leading-tight text-white md:text-6xl">
              Conditions générales de vente
            </h1>
            <p className="mx-auto mt-6 max-w-4xl text-lg leading-8 text-white/70">
              Conditions applicables aux prestations d’entretien, de ramonage mécanique,
              de dépannage et aux contrats annuels de poêles à granulés proposés par Tout Feu Tout Flamme.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-5 pb-20">
          <div className="grid gap-6">
            {sections.map((section) => (
              <article
                key={section.title}
                className="rounded-[1.5rem] border border-white/10 bg-[#1c2541]/70 p-7 shadow-xl shadow-black/10 backdrop-blur md:p-8"
              >
          ...
          <div className="mt-10 rounded-[1.75rem] border border-[#f77f00]/30 bg-[#f77f00]/10 p-7 md:p-8">
            <h2 className="font-serif text-2xl font-black text-white">Contact administratif</h2>
            <p className="mt-4 leading-8 text-white/75">
              Tout Feu Tout Flamme – Benjamin Plessis, EI<br />
              2045 rue de la vieille serre, 31800 Saint-Gaudens<br />
              Téléphone : 07 61 64 77 65<br />
              Email : benjamin.plessis@toutfeutoutflamme.eu<br />
              SIREN : 752 185 934
            </p>
