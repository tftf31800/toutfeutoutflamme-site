...
function App() {
  return (
    <>
      ...
      {/* VOILE SOMBRE GLOBAL */}
      <div className="fixed inset-0 -z-10 bg-[#020617]/35" />

      {/* BANDE CENTRALE BLEUE DÉFILANTE */}
      <main className="relative z-10 flex justify-center">
        <div className="w-full max-w-7xl border-x border-white/15 bg-[#0b132b]/92 text-white shadow-2xl shadow-black/40">
          <AppRouter />
        </div>
      </main>
    </>
