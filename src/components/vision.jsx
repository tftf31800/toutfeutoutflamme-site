<div class="premium-blog-box">
  ...
  <div class="mt-8 flex flex-col items-center gap-4 text-center">
    ...
    <div class="flex flex-wrap justify-center gap-4">
      <a
        href="/tarifs"
        class="rounded-full border border-[#f77f00]/30 bg-[#f77f00]/10 px-6 py-3 font-semibold text-[#ffb347] transition hover:bg-[#f77f00]/20"
      >
        Voir les tarifs
      </a>
      ...
      <a
        href="/contact"
        class="rounded-full border border-white/10 bg-white/5 px-6 py-3 font-semibold text-white transition hover:bg-white/10"
      >
