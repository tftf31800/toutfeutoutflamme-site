      ...
      {mobileOpen && (
        <div className="border-t border-white/10 bg-[#071426]/95 px-5 py-5 backdrop-blur-2xl lg:hidden">
          <nav className="flex flex-col gap-4">
            ...
            <a
              href={RDV_URL}
              className="mt-3 inline-flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/[0.06] px-5 py-3 font-bold text-white"
            >
              <CalendarDays size={17} />
              RDV
            </a>
            ...
            <a
              href={SUBSCRIBE_URL}
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[#f77f00] px-5 py-3 font-black text-white"
            >
              Contrats
              <ChevronRight size={17} />
            </a>
